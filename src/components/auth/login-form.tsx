        ...
        <div className={cn("flex flex-col gap-6", className)} {...props}>
            <Card>
                <CardHeader className="text-center">
                    ...
                    <CardDescription>
                        Войдите через ваш Apple или Google аккаунт
                    </CardDescription>
                </CardHeader>
                <CardContent>
                ...
                <span className="relative z-10 bg-background px-2 text-muted-foreground">
                  Или
                                ...
                                <div className="grid gap-6">
                                    ...
                                    <Button className="w-full" type="submit" disabled={!form.formState.isDirty || form.formState.isSubmitting}>
            ...
            <div
                ...
                Нажимая кнопку "Продолжить", вы соглашаетесь с нашими <a href="#">Условиями предоставления
                услуг</a>{" "}
